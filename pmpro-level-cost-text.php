    ...
    <table class="form-table">
        ...
        <tr>
            <th scope="row" valign="top"><label
                        for="level_cost_text"><?php _e( 'Level Cost Text', 'pmpro-level-cost-text' ); ?>:</label></th>
            <td>
                <textarea name="level_cost_text" rows="4"
                          style="width: 100%;"><?php echo esc_textarea( $level_cost_text ); ?></textarea>
                <br/>
                <small><?php echo sprintf( __( 'Leave blank to use the default text generated by your %s', 'pmpro-level-cost-text' ), '<a href="' . admin_url( 'admin.php?page=pmpro-advancedsettings' ) . '">' . __( 'Advanced Settings', 'pmpro-level-cost-text' ) . '.</a>' ); ?></small>
            </td>
        </tr>
        <tr>
            <th scope="row" valign="top"><label for="level_cost_text"><label
                            for="variable_references"><?php _e( 'Placeholder&nbsp;Reference', 'pmpro-level-cost-text' ); ?>
                        :</label></th>
            <td>
                <div class="template_reference"
                     style="background: #FAFAFA; border: 1px solid #CCC; color: #666; padding: 5px;">
                    <p>
                        <em><?php _e( 'Insert these variables in the level cost text field above.', 'pmpro-level-cost-text' ); ?></em>
                    </p>
...
function pclct_pmpro_level_cost_text_code( $cost, $level ) {
	...
	} else if ( ! empty( $_REQUEST['discount_code'] ) ) {
