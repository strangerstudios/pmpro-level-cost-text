...
function pclct_pmpro_membership_level_after_other_settings()
{
	...
	if($level_id > 0)
		...
		$level_cost_text = "";
?>
<h3 class="topborder"><?php _e("Custom Level Cost Text", "pclct"); ?></h3>
<p><?php _e("To override the default level cost text generated by Paid Memberships Pro. Make sure the prices in this text match your settings above.", "pclct");?></p>
<table>
