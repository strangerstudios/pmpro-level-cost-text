...
- [ ] The issue still exists against the latest `dev` branch of Paid Memberships Pro Custom Level Cost Text on Github (this is **not** the same version that downloaded from our servers!)
